...
JOBNAME='15_08_24_Long_box_run_2'
...
sed -e ${var} <~/Project/LatHyS/Lathys/sav_Makefile >~/Project/LatHyS/Lathys/Makefile

cd ~/Project/LatHyS/Lathys/
make clean
make
make diag
cd ~/Project/LatHyS/bin/
...
cp -rf $HOME/Project/LatHyS/Lathys/src $TEMPDIR/
cp -rf $HOME/Project/LatHyS/Lathys/quiet_plasma $TEMPDIR/
cp -rf $HOME/Project/LatHyS/Lathys/diag $TEMPDIR/
mv $HOME/Project/LatHyS/bin/sub_Lathys.slurm $TEMPDIR/
cp $HOME/Project/LatHyS/bin/launcher.sh $TEMPDIR/
mv $HOME/Project/LatHyS/bin/sub_restart.slurm $TEMPDIR/
